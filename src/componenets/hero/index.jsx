const Hero = ()=>{
    ...
    <h4 className="text-light-grey md:text-white text-[24px] font-['montserrat']">Food app</h4>
    <h2 className="md:text-white text-dark-grey text-[38px] md:text-[58px] font-['poppins'] mt-[18px] md:w-[937px] md:h-[160px]leading-[80px] tracking-[0.2px] mx-auto">Why stay hungry when you can order from NelsonAdedayo</h2>
